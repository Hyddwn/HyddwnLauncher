...
namespace HyddwnLauncher.PackOps.Pack
{
    public class PackWriter : IDisposable
    {
        ...
        private List<PackListEntry> _packList;
        private TempFileScope _tempOutput;
        ...
        public void WriteDirect(Stream stream, string fileName, int seed, int compressedSize, int decompressedSize, bool compress, DateTime creationTime, DateTime modifyDate, DateTime accessDate)
        {
        ...
        public void Pack()
        {
            var outputStream = File.Open(_outFile, FileMode.Create);
